...
func main() {
	logger.InitLogger()
	logger.Log.Info("✅ Logger in user service is initialized")
	defer logger.Sync()
	...
	logger.Log.Info("✅ User Service Config loaded")

	srv, err := server.NewServer(cfg)
	if err != nil {
		logger.Log.Fatal("Failed to create server: ", err)
	}
	logger.Log.Info("✅ User Service Server created")
	...
	logger.Log.Info("✅ User Service Server started")
