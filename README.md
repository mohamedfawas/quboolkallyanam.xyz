...
`git clone https://github.com/yourusername/quboolkallyanam.xyz.git`


`cd quboolkallyanam.xyz`
...
`docker compose -f deploy/compose/docker-compose.yml up -d postgres mongodb redis rabbitmq`

4. **Run database migrations**
#### Auth service
`psql -d qubool_kallyanam_auth -f services/auth/migrations/postgres/*.up.sql`

#### User service
`psql -d qubool_kallyanam_user -f services/user/migrations/postgres/*.up.sql`

#### Payment service
`psql -d qubool_kallyanam_payment -f services/payment/migrations/postgres/*.up.sql`

#### Chat service
`psql -d qubool_kallyanam_chat -f services/chat/migrations/postgres/*.up.sql`
